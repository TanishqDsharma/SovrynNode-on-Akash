let Web3,abiComplete,abiTestToken,abiSwaps,abiPriceFeed,abiRBTCWrapperProxy,abiIContractRegistry,abiConverterRegistry,abiLiquidityPoolV2Converter,conf,wallets;_3a7‍.x([["default",()=>_3a7‍.o]]);_3a7‍.w("web3",[["default",["Web3"],function(v){Web3=v}]]);_3a7‍.w("../config/abiComplete",[["default",["abiComplete"],function(v){abiComplete=v}]]);_3a7‍.w("../config/abiTestToken",[["default",["abiTestToken"],function(v){abiTestToken=v}]]);_3a7‍.w("../config/abiSovrynSwapNetwork",[["default",["abiSwaps"],function(v){abiSwaps=v}]]);_3a7‍.w("../config/abiPriceFeed",[["default",["abiPriceFeed"],function(v){abiPriceFeed=v}]]);_3a7‍.w("../config/abiRBTCWrapperProxy",[["default",["abiRBTCWrapperProxy"],function(v){abiRBTCWrapperProxy=v}]]);_3a7‍.w("../config/abiIContractRegistry",[["default",["abiIContractRegistry"],function(v){abiIContractRegistry=v}]]);_3a7‍.w("../config/abiConverterRegistry",[["default",["abiConverterRegistry"],function(v){abiConverterRegistry=v}]]);_3a7‍.w("../config/abiLiquidityPoolV2Converter",[["default",["abiLiquidityPoolV2Converter"],function(v){abiLiquidityPoolV2Converter=v}]]);_3a7‍.w("../config/config",[["default",["conf"],function(v){conf=v}]]);_3a7‍.w("../secrets/accounts",[["default",["wallets"],function(v){wallets=v}]]);/**
        ...
        return new Promise(resolve => {
            try {
                p.contractSovryn.methods.getLoan(loanId).call((error, result) => {
                    if (error) {
                        _3a7‍.g.console.error("error loading loan " + loanId);
                        _3a7‍.g.console.error(error);
                ...
                _3a7‍.g.console.error("error on retrieving loan status for loan-id " + loanId);
                _3a7‍.g.console.error(e);
                resolve(false)
            }
        });
    }
        ...
        return new Promise(async (resolve) => {
            try {
                tokenCtr.methods.balanceOf(adr).call((error, result) => {
                    if (error) {
                        _3a7‍.g.console.error("error loading wallet token balance "+adr);
                        _3a7‍.g.console.error(error);
                        return resolve(false);
                    }
                    resolve(result);
                ...
                _3a7‍.g.console.error("error on retrieving wallet status for  "+adr);
                _3a7‍.g.console.error(e);
                resolve(false)
            }
        });
        ...
        return new Promise(async (resolve) => {
            try {
                tokenCtr.methods.allowance(adr1, adr2).call((error, result) => {
                    if (error) {
                        _3a7‍.g.console.error("error loading allowance "+adr);
                        _3a7‍.g.console.error(error);
                        return resolve(false);
                    }
                ...
                _3a7‍.g.console.error("error on retrieving allowance for  "+adr);
                _3a7‍.g.console.error(e);
                resolve(false)
            }
        });
