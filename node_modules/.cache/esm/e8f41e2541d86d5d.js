let C,W,Util,conf;_41d‍.w("../controller/contract",[["default",["C"],function(v){C=v}]]);_41d‍.w("../secrets/accounts",[["default",["W"],function(v){W=v}]]);_41d‍.w("../util/helper",[["default",["Util"],function(v){Util=v}]]);_41d‍.w("../config/config",[["default",["conf"],function(v){conf=v}]]);/**
...
async function approveToken(tokenAddress, ownerAddress, spenderAddress) {
    ...
    _41d‍.g.console.log("tx hash:", txHash);
    waitForTransaction(txHash).then(txReceipt => {
        ...
        _41d‍.g.console.error('Error waiting approval transaction', e);
    });
}
...
if(require.main === module) {
    approve().then(() => {
        ...
        waitForPendingTransactions(1).then(() => {
            ...
            _41d‍.g.console.error('Error waiting for transactions', e);
        });
    }).catch(e => {
        _41d‍.g.console.error('Error in approval:', e);
    })
}
